...
2. Bootstrap stability of expression-effect ranks across sample resamples. Ranking uses all eligible
   genes before candidate-only output filtering; it does not resample the complete consensus score.
