...
- `silver_expression_tcga.parquet`
  ...
  - `data_origin`: source filepath when parsed from bronze expression files, otherwise stub/placeholder source
- `silver_expression_gtex.parquet`
  ...
  - `data_origin`: source filepath when parsed from bronze expression files, otherwise `stub`
